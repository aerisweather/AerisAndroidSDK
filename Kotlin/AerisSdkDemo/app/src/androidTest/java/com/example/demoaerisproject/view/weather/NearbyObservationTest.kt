...
@HiltAndroidTest
class NearbyObservationTest : BaseMainActivityTest() {
    @Module
    ...
    object TestWeatherModule {
        ...
        fun provideWeatherViewModel(
            ...
            model.route = NavDrawerItem.NearbyObservation.route
            return model
        }
    }
    /*
    ...
    @Test
    fun error_path() {
        composeTestRule.onNodeWithText("Nearby Observation").assertIsDisplayed()
