...
@HiltAndroidTest
class WeekendForecastTest : BaseMainActivityTest() {
    @Module
    ...
    object TestWeatherModule {
        ...
        fun provideWeatherViewModel(
            ...
            model.route = NavDrawerItem.WeekendForecast.route
            return model
        }
    }
    ...
    @Test
    fun error_path() {
        composeTestRule.onNodeWithText("Weekend Forecast").assertIsDisplayed()
