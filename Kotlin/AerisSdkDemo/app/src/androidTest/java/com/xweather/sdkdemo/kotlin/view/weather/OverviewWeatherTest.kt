...
@HiltAndroidTest
class OverviewWeatherTest : BaseMainActivityTest() {
    @Module
    ...
    object TestWeatherModule {
        ...
        fun provideWeatherViewModel(
            ...
            model.route = NavDrawerItem.Overview.route
            return model
        }
    }
    ...
    @Test
    fun error_path() {
        composeTestRule.onNodeWithText("Overview Weather").assertIsDisplayed()
